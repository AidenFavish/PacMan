...
public class RedGhost extends Ghost
{
    ...
    public RedGhost(float x, float y) {
        ...
        allImages = new TextureRegion[][]{
            {
                new TextureRegion(new Texture(Gdx.files.internal("assets/RedGhostRIGHT0.png"))),
                new TextureRegion(new Texture(Gdx.files.internal("assets/RedGhostRIGHT1.png"))),
                new TextureRegion(new Texture(Gdx.files.internal("assets/EyesRIGHT.png")))
            },
            {new TextureRegion(new Texture(Gdx.files.internal("assets/RedGhostLEFT0.png"))),
                new TextureRegion(new Texture(Gdx.files.internal("assets/RedGhostLEFT1.png"))),
                new TextureRegion(new Texture(Gdx.files.internal("assets/EyesLEFT.png")))
            },
            {new TextureRegion(new Texture(Gdx.files.internal("assets/RedGhostUP0.png"))),
                new TextureRegion(new Texture(Gdx.files.internal("assets/RedGhostUP1.png"))),
                new TextureRegion(new Texture(Gdx.files.internal("assets/EyesUP.png")))
            },
            {new TextureRegion(new Texture(Gdx.files.internal("assets/RedGhostDOWN0.png"))),
                new TextureRegion(new Texture(Gdx.files.internal("assets/RedGhostDOWN1.png"))),
    ...
    public void move(BackgroundCell[][] map, Cell pacTarget, Cell redTarget, Move facing) {
        ...
        if (GameScreen.onCenterCell(target, super.getX(), super.getY())) {
            ...
            if (best == null)
                System.out.println("Wherever should I go?");
