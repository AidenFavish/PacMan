...
public class OrangeGhost extends Ghost
{
    ...
    public OrangeGhost(float x, float y) {
        super(x, y, 36, 36);
        allImages = new TextureRegion[][]{
            {
                new TextureRegion(new Texture(Gdx.files.internal("assets/OrangeGhostRIGHT0.png"))),
                new TextureRegion(new Texture(Gdx.files.internal("assets/OrangeGhostRIGHT1.png"))),
                new TextureRegion(new Texture(Gdx.files.internal("assets/EyesRIGHT.png")))
            },
            {new TextureRegion(new Texture(Gdx.files.internal("assets/OrangeGhostLEFT0.png"))),
                new TextureRegion(new Texture(Gdx.files.internal("assets/OrangeGhostLEFT1.png"))),
                new TextureRegion(new Texture(Gdx.files.internal("assets/EyesLEFT.png")))
            },
            {new TextureRegion(new Texture(Gdx.files.internal("assets/OrangeGhostUP0.png"))),
                new TextureRegion(new Texture(Gdx.files.internal("assets/OrangeGhostUP1.png"))),
                new TextureRegion(new Texture(Gdx.files.internal("assets/EyesUP.png")))
            },
            {new TextureRegion(new Texture(Gdx.files.internal("assets/OrangeGhostDOWN0.png"))),
                new TextureRegion(new Texture(Gdx.files.internal("assets/OrangeGhostDOWN1.png"))),
    ...
    public void move(BackgroundCell[][] map, Cell pacTarget, Cell redTarget, Move facing) {
        ...
        if (getStatus() == Status.CHASE) {
            if (distance(target, pacTarget) <= 8) {
                theTarget = new Cell(1, 29);
            } else {
                theTarget = pacTarget;
            }
            speed = DEFAULT_SPEED;
